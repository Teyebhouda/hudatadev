  ...
  >
    ...
    <div
      class="absolute
             ...
             h-[500px]
             rounded-full
             bg-[radial-gradient(circle,rgba(63,83,96,0.06)_0%,transparent_70%)]
             blur-[90px]
             pointer-events-none"
    ></div>
          ...
          >
            ...
            <span
              class="w-2
                     ...
                     rounded-full
                     bg-[#c98f60]
                     shadow-[0_0_8px_rgba(201,143,96,.4)]"
            ></span>
...
const startAnimations = () => {
  ...
  nextTick(() => {
    ...
    statRefs.value.forEach(
      (element, index) => {

        const target =
          parseInt(
            props.content.stats[index]?.value ?? 0,
            10
          )
