...
Route::get('/services/{slug}', [ServiceController::class, 'showPublic'])->name('services.public.show');Route::get('/projects', [ProjectController::class, 'frontIndex'])->name('allprojects.index');
